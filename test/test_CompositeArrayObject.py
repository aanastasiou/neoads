...
from neoads import CompositeArrayObjectDict, CompositeArrayObjectList
...
try:
    import pandas
    from neoads import CompositeArrayObjectDataFrame
    ...
    warnings.warn("WARNING!!! pandas is not installed, CompositeArrayObjectDataFrame not tested")
